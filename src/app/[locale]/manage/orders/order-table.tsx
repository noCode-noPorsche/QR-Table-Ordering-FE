...
export default function OrderTable() {
  ...
  const { statics, orderObjectByGuestId, servingGuestByTableNumber } = useOrderService(
    orderList as GetOrdersResType['data']
  )
  ...
  useEffect(() => {
    ...
    function onUpdateOrder(data: UpdateOrderResType['data']) {
      ...
      toast(`Món ăn ${name} (SL: ${quantity}) vừa được cập nhật sang trạng thái ${getVietnameseOrderStatus(status)}`)
      refetch()
    }
